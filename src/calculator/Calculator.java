...
public class Calculator {
    int result; // declaring an instance variable
    public void addition(int a , int b) // declaring addition as an instance method
    {
        //int result = a + b;
        System.out.println("The addition of " + a + " and " + b + " is : " + result);
    }
    public void subtraction(int a , int b)// declaring subtraction as an instance method
    {
        //int result = a - b;
        System.out.println("The subtraction of " + a + " and " + b + " is : " + result);

    }
    public void multiplication(int a, int b)// declaring multiplication as an instance method
    {
        //int result = a * b;
        System.out.println("The multiplication of " + a + " and " + b + " is : " + result);
    }
    public void division(int a,int b)// declaring division as an instance method
    {
        //int result = a / b;
        System.out.println("The division of " + a + " and " + b + " is : " + result);
    }
    public void calculateResult(int a , int b, char symbol) // declaring calculateResult method as an instance method
    {
        if(symbol == '+')
        {
            result=a+b;
            addition(a,b);// calling an addition method
        }
        else if(symbol == '-')
        {
            result = a - b;
        ...
        {
            result = a * b;
            multiplication(a,b);// calling multiplication method
        }
        else if (symbol == '/')
        {
            result = a/b;
            division(a,b);// calling division method
        }
        else {

            System.out.println("Invalid symbol, enter the any symbol  from +,-,/,*");
             }
